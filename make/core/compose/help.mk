# Help for Doc Gen Docker Compose commands.

.PHONY: help-compose-infrastructure help-compose-init help-compose-structure help-compose-utilities
...
help-compose-structure:
	@echo [Compose Structure Workflows] $(call HELP_TOTAL,COMPOSE_STRUCTURE)
	@echo $(HELP_SEPARATOR)
	@$(ECHO_BLANK)
	@echo   make c-generate TARGET=.            $(HELP_COLUMN_SEPARATOR)    Generate project documentation
	@echo   make c-generate-smart TARGET=.      $(HELP_COLUMN_SEPARATOR)    Generate using smart mode
	@echo   make c-print TARGET=.               $(HELP_COLUMN_SEPARATOR)    Print project structure
	@echo   make c-print-smart TARGET=.         $(HELP_COLUMN_SEPARATOR)    Print using smart mode
	@echo   make c-analyze TARGET=.             $(HELP_COLUMN_SEPARATOR)    Analyze project structure
	@echo   make c-analyze-smart TARGET=.       $(HELP_COLUMN_SEPARATOR)    Analyze using smart mode
	@echo $(HELP_SEPARATOR)
	@$(ECHO_BLANK)

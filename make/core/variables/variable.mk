# Central variables for Doc Gen Make workflows.

APP_NAME := doc-gen
DISPLAY_NAME := Doc Gen
PROJECT_PACKAGE := doc_gen
...
LOCAL_RUN ?= $(PYTHON_UTF8_PREFIX) "$(PYTHON)" -m doc_gen

# Shared Doc Gen CLI arguments.
DOC_GEN_GLOBAL_ARGS ?=
DOC_GEN_EXTRA_ARGS ?=
DOC_GEN_INIT_ARGS ?=
DOC_GEN_STRUCTURE_ARGS ?= $(TARGET)
DOC_GEN_GENERATE_ARGS ?=
DOC_GEN_PRINT_ARGS ?=
DOC_GEN_ANALYZE_ARGS ?=

LOCAL_DOC_GEN_GLOBAL_ARGS ?= $(DOC_GEN_GLOBAL_ARGS)
LOCAL_DOC_GEN_EXTRA_ARGS ?= $(DOC_GEN_EXTRA_ARGS)
LOCAL_DOC_GEN_INIT_ARGS ?= $(DOC_GEN_INIT_ARGS)
LOCAL_DOC_GEN_STRUCTURE_ARGS ?= $(DOC_GEN_STRUCTURE_ARGS)
LOCAL_DOC_GEN_GENERATE_ARGS ?= $(DOC_GEN_GENERATE_ARGS)
LOCAL_DOC_GEN_PRINT_ARGS ?= $(DOC_GEN_PRINT_ARGS)
LOCAL_DOC_GEN_ANALYZE_ARGS ?= $(DOC_GEN_ANALYZE_ARGS)
...
DOCKER_DOC_GEN_GLOBAL_ARGS ?= $(DOC_GEN_GLOBAL_ARGS)
DOCKER_DOC_GEN_EXTRA_ARGS ?= $(DOC_GEN_EXTRA_ARGS)
DOCKER_DOC_GEN_INIT_ARGS ?= $(DOC_GEN_INIT_ARGS)
DOCKER_DOC_GEN_STRUCTURE_ARGS ?= $(DOC_GEN_STRUCTURE_ARGS)
DOCKER_DOC_GEN_GENERATE_ARGS ?= $(DOC_GEN_GENERATE_ARGS)
DOCKER_DOC_GEN_PRINT_ARGS ?= $(DOC_GEN_PRINT_ARGS)
DOCKER_DOC_GEN_ANALYZE_ARGS ?= $(DOC_GEN_ANALYZE_ARGS)
...
COMPOSE_DOC_GEN_GLOBAL_ARGS ?= $(DOC_GEN_GLOBAL_ARGS)
COMPOSE_DOC_GEN_EXTRA_ARGS ?= $(DOC_GEN_EXTRA_ARGS)
COMPOSE_DOC_GEN_INIT_ARGS ?= $(DOC_GEN_INIT_ARGS)
COMPOSE_DOC_GEN_STRUCTURE_ARGS ?= $(DOC_GEN_STRUCTURE_ARGS)
COMPOSE_DOC_GEN_GENERATE_ARGS ?= $(DOC_GEN_GENERATE_ARGS)
COMPOSE_DOC_GEN_PRINT_ARGS ?= $(DOC_GEN_PRINT_ARGS)
COMPOSE_DOC_GEN_ANALYZE_ARGS ?= $(DOC_GEN_ANALYZE_ARGS)

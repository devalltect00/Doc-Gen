...
RUN if [ -n "$DOC_GEN_BUILD_VERSION" ]; then \
        SETUPTOOLS_SCM_PRETEND_VERSION="$DOC_GEN_BUILD_VERSION" \
...
RUN python -c "from doc_gen.cli.main import app"

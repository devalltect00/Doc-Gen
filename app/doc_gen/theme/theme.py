...
def load_theme() -> Theme:
    return Theme(
        primary=os.getenv("PATH_HEADER_SCANNER_PRIMARY", "bold bright_blue"),
        secondary=os.getenv("PATH_HEADER_SCANNER_SECONDARY", "bright_white"),
        center=40,

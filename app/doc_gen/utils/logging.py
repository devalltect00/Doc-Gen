...
from doc_gen.constants.path import LOG_DIRECTORY, LOG_FILENAME
from doc_gen.ui.console import console
from doc_gen.utils.parsing import parse_size
...
def setup_logging(
    ...
    # Log directory
    # =========================
    level_str_file = log_file_cfg.get("level", LogLevelChoices.DEBUG)
    logging_level_file = getattr(logging, level_str_file.upper(), logging.DEBUG)
    ...
    log_file_handler.setLevel(logging_level_file)
    ...
    logging.basicConfig(
        level=min(logging_level, logging_level_file),

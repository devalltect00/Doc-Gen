...
cannot discover a source version while installing Doc Gen in an image. Build
workflows resolve the version on the host and pass it through
``DOC_GEN_BUILD_VERSION`` without copying repository metadata into an image.
"""

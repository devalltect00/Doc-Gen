# app/doc_gen/core/initialize/main.py
...
from doc_gen.core.initialize.builder.init_builder import (
    InitBuilder,
)
from doc_gen.core.initialize.models.init_config import (
    InitConfig,
)
from doc_gen.core.initialize.models.initialization_result import (
    InitializationResult,
)
from doc_gen.core.initialize.presenters.initialization_presenter import (
    InitializationPresenter,
)
from doc_gen.core.initialize.services.scaffold_generator import (
    ScaffoldGenerator,
)
...
class InitMain:
    ...
    def execute(
        ...
        try:
            ...
            console.print("  [cyan]doc-gen structure generate[/cyan]")

# app/doc_gen/cli/commands/init/options.py

from typing import Annotated

import typer

from doc_gen.cli.constants.completions import completion_initialization_mode
...
DryRunOption = Annotated[
    ...
    typer.Option(
        ...
        Preview initialization without creating directories, writing files,
        overwriting content, or prompting for confirmation.
